...
const sections = [
  ...
  { num: "7", title: "Children's Privacy", content: "Our Services are not intended for users under the age of 16. We do not knowingly collect personal data from children. If you believe a child has submitted personal information through our platform, please contact us immediately using the contact information below and we will take prompt steps to delete such information from our records." },
